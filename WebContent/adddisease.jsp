							...
							<div class="form-row">
								...
								<div class="value">
									<input class="input--style-6" id="diseasename" type="text"
										name="full_name" placeholder="Disease Name" required>
								</div>
							</div>

							<div class="form-row">
								<div class="name">Disease Duration</div>
								<div class="value">
									<input class="input--style-6" type="date" name="Period"
										id="diseasedate" required>
								</div>
							</div>
								...
								<div class="value">
									<div class="input-group">
										<textarea class="textarea--style-6" id="diseasesymptoms"
											name="message"
											placeholder="Enter the Symptoms you faced during the Disease period."
											required></textarea>
									</div>
								</div>
							</div>
							<div class="form-row">
								...
								<div class="value">
									<input class="input--style-6" id="medication" type="text"
										name="medication"
										placeholder="Medication consumed for treatment." required>
								</div>
							</div>
							<div class="form-row">
								...
								<div class="value">
									<input class="input--style-6" id="loc" type="text" name="loc"
										placeholder="City where you got infected at." required>
								</div>
							</div>
							<div class="form-row">
