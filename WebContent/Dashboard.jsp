...
<body>
	...
	<div class="sidenav">
		...
		<form action="DisplayServlet" method="get" align="center">
			...
			<hr>
			<Button name="operation" value="ViewProfile" id="b"
				style="color: #000;">View Card</Button>
			<hr>
			<Button id="b">
				<a href="changePassword.jsp">Change Password </a>
			</Button>
			<hr>
			<Button name="operation" value="ViewHistory" id="b"
				style="color: #000;">Disease History</Button>
			<hr>
			<Button name="operation" value="AddDisease" id="b">
				Add New Infected Disease
			</Button>
